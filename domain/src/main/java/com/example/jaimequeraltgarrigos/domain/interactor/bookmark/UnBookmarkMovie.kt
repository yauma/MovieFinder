...
class UnBookmarkMovie @Inject constructor(private val moviesRespostory: MoviesRepository,
                                          postExecutionThread: PostExecutionThread)
    : CompletableUseCase<UnBookmarkMovie.Params>(postExecutionThread) {

    override fun buildUseCaseCompletable(params: Params?): Completable {
        if (params != null) {
            return moviesRespostory.unbookmarkMovie(params.id)
        } else {
